...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
     ...
     * 
     * @Title：isJson
     * @Description: TODO(是否符合指定对象的json格式)
     * @see：
     * @param jsonString
     * @param e
     * @return
     */
    public static <T> boolean isJson(String jsonString, Class<T> e) {
    	try {
    		return ObjectUtils.isNotEmpty(JSON.parseObject(jsonString, e)) ? Boolean.TRUE : Boolean.FALSE;
		} catch (Exception e2) {
			return Boolean.FALSE;
		}
    }
